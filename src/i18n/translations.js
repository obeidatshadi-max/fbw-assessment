...
export const UI = {
  en: {
    ...
    intro: {
      ...
      hook1Title: 'Every rep, marketer, and manager leads from somewhere.',
      hook1Body: 'Built for pharma, medtech & diagnostics — not a generic personality test.',
      hook2Title: 'Function, Being, Will — the three sources behind every decision you make.',
      hook2Body: 'Which one is yours? Most leaders have never stopped to ask.',
      hook3Title: 'Your workplace is shaping your leadership more than you think.',
      hook3Body: 'See how it rewards — or quietly suppresses — your natural style.',
  ...
  ar: {
    ...
    intro: {
      ...
      hook1Title: 'كل مندوب ومسوّق ومدير يقود من مصدر ما.',
      hook1Body: 'صُمم خصيصاً لقيادات الصناعات الدوائية والأجهزة الطبية والتشخيص — وليس اختباراً عاماً للشخصية.',
      hook2Title: 'الوظيفة، الكينونة، الإرادة — المصادر الثلاثة وراء كل قرار تتخذه.',
      hook2Body: 'أيها مصدرك؟ معظم القادة لم يتوقفوا يوماً ليسألوا.',
      hook3Title: 'بيئة عملك تُشكّل قيادتك أكثر مما تظن.',
      hook3Body: 'اكتشف كيف تُكافئ — أو تُخمد بهدوء — أسلوبك الطبيعي.',
